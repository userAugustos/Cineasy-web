  ...
  <div class="limiter">
    <div class="container-login">
      <div class="login-content">
        ...
        <form action="../controller/POST.php" class="formLogin animated fadeIn">
          ...
          <button type="submit" class="btn btn-outline-dark btn-block">Logar</button>
        ...
        <form action="index.html" class="formRecupera animated fadeIn hide">
          <a href="/" class="text-dark"><i class="fas fa-chevron-left"></i> Voltar</a>
